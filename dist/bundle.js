...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   Tiger: () => (/* binding */ Tiger)\n/* harmony export */ });\n/* harmony import */ var _Animal__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../Animal */ \"./src/Animal.ts\");\n/* harmony import */ var _Logger__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../Logger */ \"./src/Logger.ts\");\nvar __extends = (undefined && undefined.__extends) || (function () {\n    var extendStatics = function (d, b) {\n        extendStatics = Object.setPrototypeOf ||\n            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||\n            function (d, b) { for (var p in b) if (Object.prototype.hasOwnProperty.call(b, p)) d[p] = b[p]; };\n        return extendStatics(d, b);\n    };\n    return function (d, b) {\n        if (typeof b !== \"function\" && b !== null)\n            throw new TypeError(\"Class extends value \" + String(b) + \" is not a constructor or null\");\n        extendStatics(d, b);\n        function __() { this.constructor = d; }\n        d.prototype = b === null ? Object.create(b) : (__.prototype = b.prototype, new __());\n    };\n})();\n\n\nvar logger = _Logger__WEBPACK_IMPORTED_MODULE_1__.Logger.getObject();\nvar Tiger = /** @class */ (function (_super) {\n    __extends(Tiger, _super);\n    function Tiger(animalData, outsideFromCage) {\n        var _this = _super.call(this, animalData) || this;\n        _this.outsideFromCage = outsideFromCage;\n        return _this;\n    }\n    Tiger.prototype.run = function () {\n        logger.log(\"Tiger which name is \".concat(this.name, \" can run \"));\n    };\n    Tiger.prototype.jump = function () {\n        logger.log(\"Tiger which name is \".concat(this.name, \" can jump.\"));\n    };\n    Tiger.prototype.makeSound = function () {\n        logger.log(\"Tiger which name is \".concat(this.name, \" can makes sound.\"));\n    };\n    Tiger.prototype.setGoGoutsideCage = function (goOutsideFromCage) {\n        this.outsideFromCage = goOutsideFromCage;\n        if (goOutsideFromCage) {\n            logger.log(\"Tiger which name is \".concat(this.name, \" is going outside the cage.\"));\n        }\n        else {\n            logger.log(\"Tiger which name is \".concat(this.name, \" is staying inside the cage.\"));\n        }\n    };\n    return Tiger;\n}(_Animal__WEBPACK_IMPORTED_MODULE_0__.Animal));\n\n\n\n//# sourceURL=webpack://wbepack-setup/./src/Animals/Tiger.ts?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   Zebra: () => (/* binding */ Zebra)\n/* harmony export */ });\n/* harmony import */ var _Animal__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../Animal */ \"./src/Animal.ts\");\n/* harmony import */ var _Logger__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../Logger */ \"./src/Logger.ts\");\nvar __extends = (undefined && undefined.__extends) || (function () {\n    var extendStatics = function (d, b) {\n        extendStatics = Object.setPrototypeOf ||\n            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||\n            function (d, b) { for (var p in b) if (Object.prototype.hasOwnProperty.call(b, p)) d[p] = b[p]; };\n        return extendStatics(d, b);\n    };\n    return function (d, b) {\n        if (typeof b !== \"function\" && b !== null)\n            throw new TypeError(\"Class extends value \" + String(b) + \" is not a constructor or null\");\n        extendStatics(d, b);\n        function __() { this.constructor = d; }\n        d.prototype = b === null ? Object.create(b) : (__.prototype = b.prototype, new __());\n    };\n})();\n\n\nvar logger = _Logger__WEBPACK_IMPORTED_MODULE_1__.Logger.getObject();\nvar Zebra = /** @class */ (function (_super) {\n    __extends(Zebra, _super);\n    function Zebra(animalData, max_speed, origin) {\n        var _this = _super.call(this, animalData) || this;\n        _this.max_speed = max_speed;\n        _this.origin = origin;\n        return _this;\n    }\n    Zebra.prototype.makeSound = function () {\n        logger.log(\"Zebra which name is \".concat(this.name, \" is making a sound\"));\n    };\n    Zebra.prototype.walk = function () {\n        logger.log(\"Zebra which name is \".concat(this.name, \" is walking at max speed \").concat(this.max_speed, \" km/h\"));\n    };\n    Zebra.prototype.setMaxSpeed = function (newSpeed) {\n        this.max_speed = newSpeed;\n        logger.log(\"Zebra changed speed to \".concat(newSpeed, \" km/h\"));\n    };\n    Zebra.prototype.setOrigin = function (neworigin) {\n        this.origin = neworigin;\n        logger.log(\"Zebra origin \".concat(neworigin));\n    };\n    Zebra.prototype.sleep = function () {\n        logger.log(\"Zebra which name is \".concat(this.name, \" is sleeping\"));\n    };\n    return Zebra;\n}(_Animal__WEBPACK_IMPORTED_MODULE_0__.Animal));\n\n\n\n//# sourceURL=webpack://wbepack-setup/./src/Animals/Zebra.ts?");
